<html>
<head><title>stringoperation</title></head>
<body style="background-color: pink;color:black;">
    ...
    <form method="post">
        ...
        <br><br>
        <input type="checkbox" name="string"  value="reverse" required/>Reverse
        <input type="checkbox" name="string"  value="length"/>Length of String
        <input type="checkbox" name="string"  value="substring"/>Substring
        <input type="checkbox" name="string"  value="upper"/>Uppercase
        <input type="checkbox" name="string"  value="lower"/>Lowercase
        <input type="checkbox" name="string"  value="words"/>Number of words
        <br><br>
